...
.filex-title{display:flex;align-items:center;gap:6px;min-width:0;flex:1;font-size:12px;color:var(--dsw-alias-label-primary,#e6e6e6)}
...
.filex-seg-btn{font-size:11px;font-weight:500;padding:4px 12px;border:0;background:transparent;color:var(--dsw-alias-label-secondary,#9ca3af);cursor:pointer}
...
.filex-input{width:100%;box-sizing:border-box;font-size:12px;padding:5px 8px;border-radius:6px;border:1px solid var(--dsw-alias-border-l1,rgba(128,128,128,.35));background:var(--dsw-alias-bg-base,#111);color:var(--dsw-alias-label-primary,#e6e6e6);outline:none}
.filex-input:focus{border-color:var(--dsw-alias-brand-primary,#6ea8fe)}
.filex-side-pad{padding:0 10px 6px}
.filex-rootpath{font-size:10px;font-family:ui-monospace,monospace;color:var(--dsw-alias-label-secondary,#9ca3af);margin:0 0 6px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
...
.filex-opt{min-width:22px;height:20px;padding:0 4px;display:inline-flex;align-items:center;justify-content:center;font-size:11px;font-family:ui-monospace,monospace;border-radius:5px;border:0;background:transparent;color:var(--dsw-alias-label-secondary,#9ca3af);cursor:pointer}
...
.filex-filter-label{width:30px;flex-shrink:0;text-align:right;font-size:10px;color:var(--dsw-alias-label-secondary,#9ca3af)}
.filex-filter-hint{font-size:10px;color:var(--dsw-alias-label-secondary,#9ca3af);opacity:.85;margin:0;line-height:1.5}
...
.filex-node{display:flex;align-items:center;gap:4px;width:100%;text-align:left;font-size:12px;padding:3px 6px;border:0;background:transparent;color:var(--dsw-alias-label-primary,#e6e6e6);border-radius:5px;cursor:pointer;box-sizing:border-box}
...
.filex-flat-item{display:flex;align-items:center;gap:6px;width:100%;text-align:left;font-size:12px;padding:4px 6px;border:0;background:transparent;color:var(--dsw-alias-label-primary,#e6e6e6);border-radius:5px;cursor:pointer;box-sizing:border-box}
...
.filex-search-file-name{flex:1;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-family:ui-monospace,monospace;font-size:11px;color:var(--dsw-alias-label-primary,#e6e6e6)}
.filex-search-file-count{font-size:10px;color:var(--dsw-alias-label-secondary,#9ca3af)}
.filex-search-row{display:flex;gap:6px;width:100%;text-align:left;padding:2px 6px;border:0;background:transparent;cursor:pointer;border-radius:4px;box-sizing:border-box;font-family:ui-monospace,monospace;font-size:11px;line-height:1.6;color:var(--dsw-alias-label-primary,#e6e6e6)}
...
.filex-mode-seg{margin-right:4px}
.filex-md-preview{flex:1;min-height:0;overflow:auto;padding:18px 24px;font-size:13.5px;line-height:1.75;color:var(--dsw-alias-label-primary,#e6e6e6);background:var(--dsw-alias-bg-base,#111)}
.filex-md-preview h1,.filex-md-preview h2,.filex-md-preview h3,.filex-md-preview h4,.filex-md-preview h5,.filex-md-preview h6{margin:1.2em 0 .5em;line-height:1.35;font-weight:600}
.filex-md-preview h1{font-size:1.6em;border-bottom:1px solid var(--dsw-alias-border-l1,rgba(128,128,128,.25));padding-bottom:.3em}
.filex-md-preview h2{font-size:1.35em;border-bottom:1px solid var(--dsw-alias-border-l1,rgba(128,128,128,.25));padding-bottom:.25em}
.filex-md-preview h3{font-size:1.15em}
.filex-md-preview p{margin:.5em 0}
.filex-md-preview code{background:var(--dsw-alias-bg-layer-2,rgba(128,128,128,.18));border-radius:4px;padding:1px 5px;font-family:ui-monospace,SFMono-Regular,Consolas,monospace;font-size:.9em}
.filex-md-preview pre{background:var(--dsw-alias-bg-layer-1,rgba(128,128,128,.1));border:1px solid var(--dsw-alias-border-l1,rgba(128,128,128,.25));border-radius:8px;padding:10px 14px;overflow:auto;margin:.8em 0}
.filex-md-preview pre code{background:transparent;padding:0}
.filex-md-preview blockquote{border-left:3px solid var(--dsw-alias-border-l2,rgba(128,128,128,.4));margin:.8em 0;padding:.2em 0 .2em 14px;color:var(--dsw-alias-label-secondary,#9ca3af)}
.filex-md-preview a{color:var(--dsw-alias-brand-primary,#6ea8fe);text-decoration:none}
.filex-md-preview a:hover{text-decoration:underline}
.filex-md-preview ul,.filex-md-preview ol{margin:.5em 0;padding-left:1.6em}
.filex-md-preview li{margin:.2em 0}
.filex-md-preview hr{border:0;border-top:1px solid var(--dsw-alias-border-l1,rgba(128,128,128,.3));margin:1.2em 0}
.filex-md-preview img{max-width:100%}
...
.filex-html-preview{flex:1;min-height:0;width:100%;height:100%;border:0;background:white}
